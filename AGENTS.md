...
| `design-bundle/` | The Codex Design handoff this app was ported from. `spending-tracker/project/` holds the source HTML/JSX prototypes (web + phone) and screenshots; `chats/` holds the design conversation. Read-only reference. |
